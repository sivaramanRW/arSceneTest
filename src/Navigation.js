        ...
        <div className="compass-arrow-container">
          {!loop && (
            <p className="instruction">
              Move your phone in an "8" pattern and then tap "Next"
            </p>
          )}
          {loop && customarbut && (
            <p className="instruction">
              Rotate your phone to point the arrow at the dot
            </p>
          )}
          {!customarbut && loop && (
            <p className="instruction">
              Hold your phone close, align it straight to you, and tap "Start"
            </p>
          )}
          ...
          {permissionGranted ? (
            <>
              {heading !== null && loop ? (
                ...
                >
                  ...
                  <img
                    src="compassArrow2.svg"
                    className="compass-arrow-img"
              ...
              <div className="user-location">
                {!loop && (
                  <button className="custom-ar-button" onClick={eight_loop}>
                    Next
                  </button>
                )}
                {loop && (
            ...
            <button className='buttonStyle' onClick={requestPermission}>
              Enable Compass
            </button>
          )}
        </div>
